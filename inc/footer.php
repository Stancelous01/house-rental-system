<!--Footer Section Start------------->		
	<footer class="footersection overflow">
				...
				<div class="footer_content">
					...
					<div class="footer_text overflow">
						...
						<div class="text_body">
							...
							<p>stancynaccommodations@gmail.com</p>
						</div>
					</div>
		...
		<!--Footer social links------------->	
			<div class="footer_top_lower">
				<nav class="footer_social">
					<ul>
						<li><a href=""><p class="https://www.facebook.com/Stancynn.Accomodations?mibextid=Zb"><i class="fa-brands fa-facebook-f"></i></p></a></li>
						<li><a href=""><p class="https://www.twitter.com/Stancynn.Accomodations"><i class="fa-brands fa-twitter"></i></p></a></li>
						<li><a href=""><p class="https://www.google.com/Stancynn.Accomodations"><i class="fa-brands fa-google-plus-g"></i></p></a></li>
					</ul>
				</nav>
			</div>
		</div>
		...
		<div class="footer-bottom">
			<p>&copy; Stann@2025. All Rights Reserved</p>
		</div>
	</footer>
<!--Footer Section End------------->

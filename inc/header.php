...
<?php
  ...
  header("Expires: Sat, 26 Jul 2023 05:00:00 GMT"); 
...
<head>
	...
	<meta name="author" content="Stancelous">
	<title>
		...
		<div class="top_left col overflow">
			...
			<div class="top_header_list overflow">
				<ul>
					<li>
						<p>
							<i class="fa-solid fa-phone"></i><span>Phone: +254706683704</span>
						</p>
					</li>
					<li>
						<p>
							<i class="fa-solid fa-envelope"></i>
							</i><span>Email: info@stancynaccommodations.com</span>
						</p>
					</li>
				</ul>
			</div>

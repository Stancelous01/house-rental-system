				...
				<div class="admin_property_table small_display_table">
					...
					<?php
						...
						<tr>
							...
							<td width="12%"><p>Ksh<img class="Ksh" style="position:relative;top:-.4em;" src="../images/taka.png" alt="Ksh"/><?php echo $adlist['adRent']+$adlist['gasBill']+$adlist['electricBill']+$adlist['sCharge'];?>/<?php echo $adlist['rentType'];?></p></td>

		...
		<div class="property_details_list">
			...
			<div class="property_details_body">
				...
				<div class="property_feature overflow">
					...
					<div><p><span><?php if($ad['rentType'] == "monthly"){echo"Per month";} else{echo"Per week";} ?></span></p></div>
				</div>
				
				<div class="property_feature overflow">
					<div><p>gas bill</p></div>
					<div><p><span>Ksh<?php echo $ad['gasBill'];?></span></p></div>
				</div>
				
				<div class="property_feature overflow">
					<div><p>electric bill</p></div>
					<div><p><span>Ksh<?php echo $ad['electricBill']; if($ad['eBillType'] == "Inc"){echo" (Including)";} else{echo" (Excluding)";} ?></span></p></div>
				</div>
				
				<div class="property_feature overflow">
					<div><p>service charge</p></div>
					<div><p><span>Ksh<?php echo $ad['sCharge'];?></span></p></div>
				</div>

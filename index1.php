				...
				<a href="property_details.php">
					<div class="item_box overflow">
						<div class="item_box_upper overflow">
							...
							<div class="item_upper item_pricebox overflow">
								<div class="item_upper_left">
									<p><span class="currency">KSh</span></i><span>8000/month</span></p>
								</div>
						...
						<div class="item_box_lower overflow"> 
							<p>Dream Apartment in Nairobi – Move-in Ready! 🏡</p>
							<h3><i class="fa-brands fa-accusoft"></i><span>Flat/Appertment</span></h3>
							<p><i class="fa-solid fa-file-pen"></i>Posted on: July 3, 2025</p>
							<p><span class="currency">KSh</span></i>8000/mo <span>(Negotiable)</span></p>
							<p><i class="fa-solid fa-location-dot"></i>Umoja - Nairobi</p>
						</div>
					</div>
				</a>
			</div>
				...
				<a href="property_details.php">
					<div class="item_box overflow">
						<div class="item_box_upper overflow">
							...
							<div class="item_upper item_pricebox overflow">
								<div class="item_upper_left">
									<p><span class="currency">KSh</span></i><span>19000/month</span></p>
								</div>
								<div class="item_upper_left item_wlist_icon">
									<p><i class="fa-solid fa-heart"></i></p>
								</div>
						...
						<div class="item_box_lower overflow"> 
							<p>Huruma Rental Flat | Near Schools & Markets Huruma Gem! 🏡</p>
							<h3><i class="fa-brands fa-accusoft"></i><span>Flat/Appertment</span></h3>
							<p><i class="fa-solid fa-file-pen"></i>Posted on: July 3, 2025</p>
							<p><span class="currency">KSh</span></i>19000/mo <span>(Negotiable)</span></p>
							<p><i class="fa-solid fa-location-dot"></i>Huruma - Nairobi</p>
						</div>
					</div>
				</a>
			</div>
				...
				<a href="property_details.php">
					<div class="item_box overflow">
						<div class="item_box_upper overflow">
							...
							<div class="item_upper item_pricebox overflow">
								<div class="item_upper_left">
									<p><i class="fa-solid fa-dollar-sign"></i><span>650000/month</span></p>
								</div>
								<div class="item_upper_left item_wlist_icon">
									<p><i class="fa-solid fa-heart"></i></p>
								</div>
						...
						<div class="item_box_lower overflow"> 
							<p>5bdrm House in Loresho for rent</p>
							<h3><i class="fa-brands fa-accusoft"></i><span>Flat/Appertment</span></h3>
							<p><i class="fa-solid fa-file-pen"></i>Posted on: July 6, 2025</p>
							<p><i class="fa-solid fa-dollar-sign"></i>650000/mo <span>(Negotiable)</span></p>
							<p><i class="fa-solid fa-location-dot"></i>Westlands - Nairobi</p>
						</div>
					</div>
				</a>
			</div>
